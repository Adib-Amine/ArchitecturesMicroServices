package com.adib.authentificationservice;
...
public class AuthentificationServiceApplication {
    ...
    CommandLineRunner start(AccountService accountService){
        return args -> {
            ...
            accountService.addNewUser(new AppUser(null,"user_1","amine",new ArrayList<>()));
            accountService.addNewUser(new AppUser(null,"admin","adib",new ArrayList<>()));
